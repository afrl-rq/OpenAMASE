...
/**
 Region that defines water areas navigable for surface vehicles. Ground vehicles        should not enter this zone. 
*/
public class WaterZone extends afrl.cmasi.AbstractZone {
    ...
    private static final String TYPE_NAME = "WaterZone";

    private static final String FULL_LMCP_TYPE_NAME = "afrl.impact.WaterZone";
    ...
    public WaterZone clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            WaterZone newObj = new WaterZone();
            newObj.unpack(bis);
            return newObj;
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<WaterZone Series=\"IMPACT\">\n");
    ...
    public boolean equals(Object anotherObj) {
        ...
        WaterZone o = (WaterZone) anotherObj;
