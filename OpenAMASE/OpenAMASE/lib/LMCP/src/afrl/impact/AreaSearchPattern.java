...
public enum AreaSearchPattern {
    ...
    public static AreaSearchPattern unpack(InputStream in) throws IOException{
    ...
    public static AreaSearchPattern getEnum(int val) {
        switch(val) {
