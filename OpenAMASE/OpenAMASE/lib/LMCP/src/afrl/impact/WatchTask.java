...
/**
 Vehicle Watch task 
*/
public class WatchTask extends afrl.cmasi.SearchTask {
    ...
    private static final String TYPE_NAME = "WatchTask";

    private static final String FULL_LMCP_TYPE_NAME = "afrl.impact.WatchTask";
    ...
    public WatchTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, long DwellTime, float GroundSampleDistance, long WatchedEntityID){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    public WatchTask clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            WatchTask newObj = new WatchTask();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  Entity ID to follow and watch (Units: None)*/
    public WatchTask setWatchedEntityID( long val ) {
        WatchedEntityID = val;
        return this;
    }
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<WatchTask Series=\"IMPACT\">\n");
    ...
    public boolean equals(Object anotherObj) {
        ...
        WatchTask o = (WatchTask) anotherObj;
