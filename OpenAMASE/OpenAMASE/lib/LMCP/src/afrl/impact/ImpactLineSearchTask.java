...
*/
public class ImpactLineSearchTask extends afrl.cmasi.SearchTask {
    ...
    private static final String TYPE_NAME = "ImpactLineSearchTask";

    private static final String FULL_LMCP_TYPE_NAME = "afrl.impact.ImpactLineSearchTask";
    ...
    public ImpactLineSearchTask() {
    }

    public ImpactLineSearchTask(long TaskID, String Label, float RevisitRate, short Priority, boolean Required, long DwellTime, float GroundSampleDistance, long LineID, boolean UseInertialViewAngles){
        this.TaskID = TaskID;
        this.Label = Label;
    ...
    public ImpactLineSearchTask clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            ImpactLineSearchTask newObj = new ImpactLineSearchTask();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  ID of line to search (from available lines of interest) (Units: None)*/
    public ImpactLineSearchTask setLineID( long val ) {
        LineID = val;
        return this;
    }
    ...
    /**  If true, the ViewAngleList specifies inertial (North-East) angles. See documentation above. (Units: None)*/
    public ImpactLineSearchTask setUseInertialViewAngles( boolean val ) {
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<ImpactLineSearchTask Series=\"IMPACT\">\n");
        ...
        buf.append( ws + "</ImpactLineSearchTask>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        ImpactLineSearchTask o = (ImpactLineSearchTask) anotherObj;
