...
*/
public class GimbalState extends afrl.cmasi.PayloadState {
    ...
    private static final String TYPE_NAME = "GimbalState";

    private static final String FULL_LMCP_TYPE_NAME = "afrl.cmasi.GimbalState";
    ...
    public GimbalState(long PayloadID, afrl.cmasi.GimbalPointingMode PointingMode, float Azimuth, float Elevation, float Rotation){
    ...
    public GimbalState clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            GimbalState newObj = new GimbalState();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  Current pointing mode of the gimbal (Units: None)*/
    public GimbalState setPointingMode( afrl.cmasi.GimbalPointingMode val ) {
        PointingMode = val;
        return this;
    }
    ...
    /**  Current azimuth angle of the gimbal boresight (positive from vehicle x-axis). (Units: degree)*/
    public GimbalState setAzimuth( float val ) {
        Azimuth = val;
        return this;
    }
    ...
    /**  Current elevation angle of the gimbal boresight (positive from vehicle x-y plane). (Units: degree)*/
    public GimbalState setElevation( float val ) {
        Elevation = val;
        return this;
    }
    ...
    /**  Current rotation angle of the gimbal boresight (0 degrees aligned with aircraft normal, positive clockwise). (Units: degree)*/
    public GimbalState setRotation( float val ) {
        Rotation = val;
        return this;
    }
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<GimbalState Series=\"CMASI\">\n");
    ...
    public boolean equals(Object anotherObj) {
        ...
        GimbalState o = (GimbalState) anotherObj;
