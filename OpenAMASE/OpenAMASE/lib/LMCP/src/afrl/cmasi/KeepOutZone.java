...
/**
            Defines a keep-out zone.  This describes a volume where vehicles are not allowed            to fly. For standard zones, this Struct defines lateral boundaries.        
*/
public class KeepOutZone extends afrl.cmasi.AbstractZone {
    ...
    private static final String TYPE_NAME = "KeepOutZone";

    private static final String FULL_LMCP_TYPE_NAME = "afrl.cmasi.KeepOutZone";
    ...
    *<br/> Threat Defines an area where a threat is present. (Units: None)*/
    @LmcpType("ZoneAvoidanceType")
    protected afrl.cmasi.ZoneAvoidanceType ZoneType = afrl.cmasi.ZoneAvoidanceType.Physical;

    
    public KeepOutZone() {
    }

    public KeepOutZone(long ZoneID, float MinAltitude, afrl.cmasi.AltitudeType MinAltitudeType, float MaxAltitude, afrl.cmasi.AltitudeType MaxAltitudeType, long StartTime, long EndTime, float Padding, String Label, afrl.cmasi.AbstractGeometry Boundary, afrl.cmasi.ZoneAvoidanceType ZoneType){
        this.ZoneID = ZoneID;
    ...
    public KeepOutZone clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            KeepOutZone newObj = new KeepOutZone();
            newObj.unpack(bis);
            return newObj;
    ...
    *<br/> Acoustic Defines an area for acoustical avoidance 
    *<br/> Threat Defines an area where a threat is present. (Units: None)*/
    public afrl.cmasi.ZoneAvoidanceType getZoneType() { return ZoneType; }
    ...
    *<br/> Acoustic Defines an area for acoustical avoidance 
    *<br/> Threat Defines an area where a threat is present. (Units: None)*/
    public KeepOutZone setZoneType( afrl.cmasi.ZoneAvoidanceType val ) {
        ZoneType = val;
        return this;
    }
    ...
    public void unpack(InputStream in) throws IOException {
        super.unpack(in);
        ZoneType = afrl.cmasi.ZoneAvoidanceType.unpack( in );
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<KeepOutZone Series=\"CMASI\">\n");
    ...
    public boolean equals(Object anotherObj) {
        ...
        KeepOutZone o = (KeepOutZone) anotherObj;
