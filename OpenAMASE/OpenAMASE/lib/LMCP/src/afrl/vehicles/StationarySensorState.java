...
*/
public class StationarySensorState extends afrl.cmasi.EntityState {
    ...
    private static final String TYPE_NAME = "StationarySensorState";

    private static final String FULL_LMCP_TYPE_NAME = "afrl.vehicles.StationarySensorState";


    
    public StationarySensorState() {
    }



    public StationarySensorState clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            StationarySensorState newObj = new StationarySensorState();
            newObj.unpack(bis);
            return newObj;
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<StationarySensorState Series=\"VEHICLES\">\n");
        ...
        buf.append( ws + "  </Info>\n");
        buf.append( ws + "</StationarySensorState>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        StationarySensorState o = (StationarySensorState) anotherObj;
