...
/**
 Entity Join 
*/
public class EntityJoin extends avtas.lmcp.LMCPObject {
    ...
    private static final String TYPE_NAME = "EntityJoin";

    private static final String FULL_LMCP_TYPE_NAME = "uxas.messages.uxnative.EntityJoin";
    ...
    public EntityJoin(long EntityID, String Label){
        this.EntityID = EntityID;
        this.Label = Label;
    }


    public EntityJoin clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            EntityJoin newObj = new EntityJoin();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  ID of entity joining network (Units: None)*/
    public EntityJoin setEntityID( long val ) {
        EntityID = val;
        return this;
    }
    ...
    /**  Label of entity joining network (Units: None)*/
    public EntityJoin setLabel( String val ) {
        Label = val;
        return this;
    }
    ...
    public boolean equals(Object anotherObj) {
        ...
        EntityJoin o = (EntityJoin) anotherObj;
