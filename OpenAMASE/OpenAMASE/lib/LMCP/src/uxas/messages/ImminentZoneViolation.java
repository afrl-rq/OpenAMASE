...
/**
 Indicates that a zone will be violated in the future if vehicle remains on last reported trajectory 
*/
public class ImminentZoneViolation extends uxas.messages.ZoneViolation {
    ...
    private static final String TYPE_NAME = "ImminentZoneViolation";

    private static final String FULL_LMCP_TYPE_NAME = "uxas.messages.ImminentZoneViolation";


    
    public ImminentZoneViolation() {
    }



    public ImminentZoneViolation clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            ImminentZoneViolation newObj = new ImminentZoneViolation();
            newObj.unpack(bis);
            return newObj;
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<ImminentZoneViolation Series=\"ALERTS\">\n");
        ...
        buf.append( ws + "</ImminentZoneViolation>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        ImminentZoneViolation o = (ImminentZoneViolation) anotherObj;
