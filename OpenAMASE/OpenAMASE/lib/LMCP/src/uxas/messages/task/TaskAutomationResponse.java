...
*/
public class TaskAutomationResponse extends avtas.lmcp.LMCPObject {
    ...
    private static final String TYPE_NAME = "TaskAutomationResponse";

    private static final String FULL_LMCP_TYPE_NAME = "uxas.messages.task.TaskAutomationResponse";
    ...
    public TaskAutomationResponse() {
    }

    public TaskAutomationResponse(long ResponseID, afrl.cmasi.AutomationResponse OriginalResponse){
        this.ResponseID = ResponseID;
        this.OriginalResponse = OriginalResponse;
    }


    public TaskAutomationResponse clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            TaskAutomationResponse newObj = new TaskAutomationResponse();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  Identifier for tracking requests and responses. Must match RequestID from corresponding TaskAutomationRequest (Units: None)*/
    public TaskAutomationResponse setResponseID( long val ) {
        ResponseID = val;
        return this;
    }
    ...
    /**  Original automation request without a unique identifier. A valid TaskAutomationResponse must define OriginalResponse (null not allowed). (Units: None)*/
    public TaskAutomationResponse setOriginalResponse( afrl.cmasi.AutomationResponse val ) {
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<TaskAutomationResponse Series=\"UXTASK\">\n");
        ...
        buf.append( ws + "  </FinalStates>\n");
        buf.append( ws + "</TaskAutomationResponse>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        TaskAutomationResponse o = (TaskAutomationResponse) anotherObj;
