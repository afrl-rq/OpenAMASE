...
*/
public class TaskPause extends avtas.lmcp.LMCPObject {
    ...
    private static final String TYPE_NAME = "TaskPause";

    private static final String FULL_LMCP_TYPE_NAME = "uxas.messages.task.TaskPause";
    ...
    public TaskPause(long TaskID){
        this.TaskID = TaskID;
    }


    public TaskPause clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            TaskPause newObj = new TaskPause();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  Task ID (Units: None)*/
    public TaskPause setTaskID( long val ) {
        TaskID = val;
        return this;
    }
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<TaskPause Series=\"UXTASK\">\n");
        buf.append( ws + "  <TaskID>" + String.valueOf(TaskID) + "</TaskID>\n");
        buf.append( ws + "</TaskPause>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        TaskPause o = (TaskPause) anotherObj;
