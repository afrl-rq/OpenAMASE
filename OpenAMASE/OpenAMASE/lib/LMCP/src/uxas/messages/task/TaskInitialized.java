...
*/
public class TaskInitialized extends avtas.lmcp.LMCPObject {
    ...
    private static final String TYPE_NAME = "TaskInitialized";

    private static final String FULL_LMCP_TYPE_NAME = "uxas.messages.task.TaskInitialized";
    ...
    public TaskInitialized() {
    }

    public TaskInitialized(long TaskID){
        this.TaskID = TaskID;
    }


    public TaskInitialized clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            TaskInitialized newObj = new TaskInitialized();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  Task ID is initialized and ready for use in automation requests (Units: None)*/
    public TaskInitialized setTaskID( long val ) {
        TaskID = val;
        return this;
    }
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<TaskInitialized Series=\"UXTASK\">\n");
        buf.append( ws + "  <TaskID>" + String.valueOf(TaskID) + "</TaskID>\n");
        buf.append( ws + "</TaskInitialized>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        TaskInitialized o = (TaskInitialized) anotherObj;
