...
*/
public class UniqueAutomationRequest extends avtas.lmcp.LMCPObject {
    ...
    private static final String TYPE_NAME = "UniqueAutomationRequest";

    private static final String FULL_LMCP_TYPE_NAME = "uxas.messages.task.UniqueAutomationRequest";

    /**  Identifier for tracking requests and responses (Units: None)*/
    @LmcpType("int64")
    protected long RequestID = 0L;
    /**  Original automation request without a unique identifier. A valid UniqueAutomationRequest must define OriginalRequest (null not allowed). (Units: None)*/
    ...
    public UniqueAutomationRequest() {
    }

    public UniqueAutomationRequest(long RequestID, afrl.cmasi.AutomationRequest OriginalRequest, boolean SandBoxRequest){
    ...
    public UniqueAutomationRequest clone() {
        try {
            java.io.ByteArrayOutputStream bos = new java.io.ByteArrayOutputStream( calcSize() );
            pack(bos);
            java.io.ByteArrayInputStream bis = new java.io.ByteArrayInputStream(bos.toByteArray());
            UniqueAutomationRequest newObj = new UniqueAutomationRequest();
            newObj.unpack(bis);
            return newObj;
    ...
    /**  Identifier for tracking requests and responses (Units: None)*/
    public UniqueAutomationRequest setRequestID( long val ) {
        RequestID = val;
        return this;
    }
    ...
    /**  Original automation request without a unique identifier. A valid UniqueAutomationRequest must define OriginalRequest (null not allowed). (Units: None)*/
    public UniqueAutomationRequest setOriginalRequest( afrl.cmasi.AutomationRequest val ) {
        OriginalRequest = val;
        return this;
    }
    ...
    /**  If this boolean is true, then the resulting plans based on this automation request will not be directly implemented, for example, tasks should not expect the waypoints generated for this request to be active (Units: None)*/
    public UniqueAutomationRequest setSandBoxRequest( boolean val ) {
        SandBoxRequest = val;
        return this;
    }
    ...
    public String toXML(String ws) {
        ...
        buf.append( ws + "<UniqueAutomationRequest Series=\"UXTASK\">\n");
        ...
        buf.append( ws + "  </PlanningStates>\n");
        buf.append( ws + "</UniqueAutomationRequest>");
    ...
    public boolean equals(Object anotherObj) {
        ...
        UniqueAutomationRequest o = (UniqueAutomationRequest) anotherObj;
